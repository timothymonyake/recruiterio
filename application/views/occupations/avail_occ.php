  ...
  <link href="<?php //echo base_url('assets/bootstrap/css/grayscale.min.css');?>" rel="stylesheet">-->
   ...
   <script type="text/javascript">
       function deleteOccupation(id)
       {
           ...
           {
               window.location.href = "<?php echo base_url('Occupations/deleteO');?>"+'/'+id;
           }
       }
   </script>
            ...
            <div class = "modal-dialog" role = "document">
               <div class = "modal-content">
                  ...
                  <div class = "modal-body">
                        <form class="form-horizontal" method="post" action="<?php echo base_url('Occupations/addOccupation')?> ">   
                            <div class="form-group">  
                                <label>Title</label>
                                     <input type="text" class="col-lg-12 input-md form-control" name="title" required="" /> 
                                 </div>                 
                                  <div class="form-group">
                                      <label>Description</label>
                                      <textarea class="col-lg-12 input-md form-control" name="description"> 
                                     </textarea>
                                  </div>    
                            <input type="submit" href="<?php base_url('Occupations/addOccupation')?> " name="submit" value="Add Occupation" class="btn btn-block btn-md btn-success col-lg-12"/>
                        </form>
                               </div>
        ...
        <div class="col-lg-6">
         ...
         <?php
          ...
          <?php
            ...
            <?php
             if($err_edit = $this->session->flashdata('err_edit'))
            {
            ?>
              <div class="col-sm-12">
                <div class="alert alert-danger" >
                ...
                <thead>
                 ...
                 <tbody>
                   ...
                   <tr>
                       ...
                       <td>
                            <a class="btn  btn-sm btn-icon icon-left text-primary" style="margin: 0px"  data-toggle="modal" data-target="#test<?php echo $row['id']?>" title="edit occupation" onclick=""><i class="far fa-edit"></i>
                            </a>&nbsp;
                            <a class="btn  btn-sm btn-icon icon-left text-danger" href="javascript:deleteOccupation(<?php echo $row['id']?>)" title="delete occupation"><i class="fas fa-minus-circle"></i>
                            </a>
                       </td>                       
            ...
            <div class = "modal-dialog" role = "document">
               <div class = "modal-content">
                  ...
                  <div class = "modal-body">
                        <form action="<?php echo base_url('Occupations/updateO')?>" method="post">
                          
                                <?php $result = $this->db->get_where('occupation',array('id'=>$row['id']))->row_array();
                                    //print_r($result);
                                ...
                                <label>Title</label> 
                              <div class="form-group">                 
                                  <input type="text" class="col-lg-12 input-md form-control" value="<?php echo $result['title']?>" name="utitle" required="" placeholder=""/> 
                              </div>       

                               <div class="form-group">
                                   <label>Description</label> 
                                   <textarea class="col-lg-12 input-md form-control" placeholder="" value="" name="udescription">
